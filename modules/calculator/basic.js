// ========== ИНЖЕНЕРНЫЙ КАЛЬКУЛЯТОР С ИСТОРИЕЙ ==========
...
function renderCalculator() {
    ...
    container.innerHTML = `
        <div style="max-width: 600px; margin: 20px auto; display: flex; gap: 15px; flex-wrap: wrap;">
            <!-- Калькулятор -->
            ...
            <!-- Панель истории -->
            <div id="historyPanel" style="flex: 1; min-width: 200px; background: #2c1810; border-radius: 12px; padding: 15px; border: 2px solid #8b4513; display: none;">
