...
const alchemyData = {
    introduction: `
        ...
        <div style="margin-bottom: 20px; padding: 15px; background: #2a1a0f; border-radius: 6px;">
            ...
            <p style="color: #e0d0c0;">Для создания алхимических продуктов необходима лаборатория. <strong>Без лаборатории и хороших условий зелья варить нельзя.</strong></p>
        ...
        <div style="margin-bottom: 20px; padding: 15px; background: #2a1a0f; border-radius: 6px;">
            ...
            <p style="color: #e0d0c0;">Разбирать готовые зелья для изучения рецептов нельзя. <strong>Экспериментальное смешивание даёт непредсказуемый эффект.</strong></p>
        </div>
        ...
        <div style="margin-bottom: 20px; padding: 15px; background: #2a1a0f; border-radius: 6px;">
            ...
            <ol style="color: #e0d0c0; margin-left: 20px;">
                <li>Иметь <strong>лабораторию</strong> (без лаборатории и хороших условий зелья варить нельзя).</li>
                <li>Иметь <strong>ингредиенты</strong> (травы, минералы, органика, магические компоненты). <strong>У каждого ингредиента свои свойства. По сути всё заменимо на другие ингредиенты, но от этого может поменяться эффективность и эффект зелья.</strong></li>
                <li>Знать <strong>рецепт</strong> (пропорции, последовательность действий, условия). Длительность эффекта указана в рецепте. Существуют зелья, которые срабатывают не сразу, а с отсрочкой или при условии.</li>
            </ol>
            
            <h4 style="color: #b89a7a; margin-top: 10px;">Бросок:</h4>
            <p style="color: #e0d0c0;">Бросается <strong>3d6</strong>. Для успеха нужно бросить <strong>меньше или равно</strong> (навык алхимии − сложность рецепта).</p>
            
            <h4 style="color: #b89a7a; margin-top: 10px;">Сложность варки:</h4>
            <p style="color: #e0d0c0;">У каждого рецепта есть своя сложность. Штрафы и бонусы применяются к навыку.</p>
            
            <h4 style="color: #b89a7a; margin-top: 10px;">Первые приготовления (обычная лаборатория):</h4>
            <ul style="color: #e0d0c0; margin-left: 20px;">
                <li>Первые 2 варки: <strong>−5</strong> к навыку</li>
                <li>Следующие 2 варки: <strong>−4</strong></li>
                <li>Следующие 2 варки: <strong>−3</strong></li>
                <li>Следующие 2 варки: <strong>−2</strong></li>
                <li>Следующие 2 варки: <strong>−1</strong></li>
                <li>10-я и далее: <strong>без штрафа</strong></li>
            </ul>
            ...
            <h4 style="color: #b89a7a; margin-top: 10px;">Магические инструменты:</h4>
            <p style="color: #e0d0c0;">Дают бонус к навыку при варке. Штрафы за первые приготовления уменьшаются:</p>
            <ul style="color: #e0d0c0; margin-left: 20px;">
                <li>Первые 3 варки: <strong>−3</strong> к навыку</li>
                <li>Следующие 3 варки: <strong>−2</strong></li>
                <li>Следующие 3 варки: <strong>−1</strong></li>
                <li>10-я и далее: <strong>без штрафа</strong></li>
            </ul>
            
            <h4 style="color: #b89a7a; margin-top: 10px;">Провал:</h4>
            <p style="color: #e0d0c0;">При провале <strong>ингредиенты портятся</strong>. Обычные инструменты могут повредиться (требуют ремонта), магические — сложнее повредить.</p>
        </div>
        ...
        <div style="margin-bottom: 20px; padding: 15px; background: #2a1a0f; border-radius: 6px;">
            ...
            <p style="color: #b89a7a; margin-top: 10px;"><strong>Размер зелья влияет на эффективность эффекта и на интоксикацию.</strong></p>
        </div>

        <div style="margin-bottom: 20px; padding: 15px; background: #2a1a0f; border-radius: 6px;">
            <h3 style="color: #d4af37; margin-bottom: 10px;">⚠️ ИНТОКСИКАЦИЯ:</h3>
            <p style="color: #e0d0c0;">У каждого зелья есть показатель интоксикации — нагрузка на организм. <strong>Яд не даёт отдельную интоксикацию — это по сути и есть интоксикация. Если превысить допустимую дозировку, начинается отравление.</strong></p>
            <p style="color: #e0d0c0;">Интоксикация зависит от силы зелья:</p>
            <ul style="color: #e0d0c0; margin-left: 20px;">
            ...
            <p style="color: #e0d0c0;">Интоксикация <strong>складывается от всех выпитых зелий</strong>. Если текущий уровень <strong>11–15</strong>, то каждая единица выше 10 снимается со скоростью <strong>5 часов</strong>. Когда уровень опускается до 10, оставшиеся единицы снимаются со скоростью <strong>2 часа</strong>.</p>
            ...
            <p style="color: #e0d0c0;"><strong>Существуют зелья, которые ускоряют снятие интоксикации в два раза. У таких зелий нет собственной интоксикации.</strong></p>
        </div>

        <div style="margin-bottom: 20px; padding: 15px; background: #2a1a0f; border-radius: 6px;">
            <h3 style="color: #d4af37; margin-bottom: 10px;">📦 ХРАНЕНИЕ ЗЕЛИЙ:</h3>
            <p style="color: #e0d0c0;">При должных условиях зелья хранятся довольно долго. У каждого зелья свои сроки, но в основном это <strong>месяцы или даже годы</strong>.</p>
        </div>
    `
};
